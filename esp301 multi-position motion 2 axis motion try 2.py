...
import time
controller = espModeStirring.espModeStirring("COM3",921600, 1, True, 0.0, [1,2]) # newport controller device, baud rate, default axis 
...
def multiMotion(array):
    for subArray in array:
        controller.setpos2wait(subArray[0],subArray[1], subArray[2], 1, 2)
